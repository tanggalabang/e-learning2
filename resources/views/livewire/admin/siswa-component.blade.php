              ...
              <div class="card-body">
                ...
                <div class="buttons mb-3">
                  <button class="btn btn-icon icon-left btn-primary" data-toggle="modal" data-target="#addStudentModal">
                    <i data-feather="user-plus" style="width:12px; margin-bottom: 3px;"></i>
                    Tambah
                  </button>
                  <button type="button" class="btn btn-icon icon-left btn-success" data-toggle="modal"
                    data-target=".bd-example-modal-sm">
                    <i data-feather="download" style="width:12px; margin-bottom: 3px;"></i>
                    Import Excel
                  </button>
                  <a href="{{url('admin/siswa/excel')}}" class="btn btn-icon icon-left btn-warning"><i data-feather="upload" style="width:12px; margin-bottom: 3px;"></i> Export Excel</a>
                </div>
                <div class="row mb-3">
                  <div class="col-8">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td style="text-align: center;">
                      <button class="btn btn-sm btn-secondary" wire:click="viewStudentDetails({{ $siswa->id }})">Lihat</button>
                      <button class="btn btn-sm btn-primary" wire:click="editStudents({{ $siswa->id }})">Edit</button>
                      <button class="btn btn-sm btn-danger" wire:click="deleteConfirmation({{ $siswa->id }})">Hapus</button>
                    </td>
                  </tr>
                  @endforeach
                  @else
        ...
        <div class="modal-body">
          <div class="form-group">
            ...
            <div class="input-group">
              <a href="{{url('/admin/siswa/excel-example')}}" class="btn btn-icon btn-primary"><i class="far fa-edit"></i></a>
            </div>
          </div>
          <div class="form-group">
