      ...
      <div class="modal-body">
        ...
        <form wire:submit.prevent="storeStudentData">
          ...
          <div class="form-group row">
            <label for="nis" class="col-3">KODE KELAS</label>
            <div class="col-9">
              <input type="number" id="kode_kelas" class="form-control" wire:model="kode_kelas">
              @error('kode_kelas')
          ...
          <div class="form-group row">
            <label for="nama" class="col-3">KELAS</label>
            <div class="col-9">
              <input type="text" id="kelas_pendek" class="form-control" wire:model="kelas_pendek">
              @error('kelas_pendek')
              <span class="text-danger" style="font-size: 11.5px;">{{ $message }}</span>
              @enderror
            </div>
